...
os.chdir("/home/orangepi/Documents/human-action-recognition-master1")
...
model.load_state_dict(torch.load('/home/orangepi/Documents/human-action-recognition-master1/model/10action_25kp_100_64_0.01.pth', map_location=torch.device('cpu')))
model.eval()
...
captured_image_path = "/home/orangepi/Documents/human-action-recognition-master1/picture_fall/captured_fall_image.jpg"
...
async def process_frames():
    ...
    while True:
        ...
        # Kiểm tra kết nối Wi-Fi và thực hiện nhận diện hành động
        if check_wifi_connection(wifi_name):
            # Nhận diện hành động chỉ khi đã kết nối Wi-Fi
