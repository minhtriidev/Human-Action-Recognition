...
from mediapipe_function_4 import convert_landmarks, make_landmark_timestep, convert_landmarks_25


# Khai báo thông tin model
model = ST_GCN(num_classes=9, in_channels=3, t_kernel_size=9, hop_size=2)
model.load_state_dict(torch.load('10action_100_64_0.01.pth', map_location=torch.device('cpu')))
model.eval()
...
action_labels = ['clap', 'fall', 'jump', 'run', 'sit', 'stand', 'walk', 'wave']
