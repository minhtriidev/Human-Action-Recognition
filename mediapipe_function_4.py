...
#landmark_33_mediapipe
def convert_landmarks_33(kinect_v2_landmarks, scale_factor):
...
def plot_3d_landmarks_25(kinect_v2_landmarks, elev, azim):
    fig = plt.figure()
...
def plot_3d_landmarks_33(kinect_v2_landmarks, elev, azim):
    fig = plt.figure()
    ax = fig.add_subplot(111, projection='3d')
    ...
    # Plot connections
    connections = [
        (8,5), (5,0), (0,2), (2,7), (10,9), # head
        (18,20), (18,16), (20,16), (16,22), (16,14), (14,12), # right hand
        (17,19), (17,15), (19,15), (15,21), (15,13), (13,11), # left hand
        (12,11), (12,24), (11,23), (24, 23), # body
