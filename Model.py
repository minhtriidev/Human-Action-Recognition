...
#   def __init__(self, data_path, label_path, video_name):
#       super().__init__()
#       self.label = np.load(label_path)
#       self.data = np.load(data_path)
#       self.video_names = np.load(video_name)
...
#       video_names = str(self.video_names[index])

#       return data, label, video_names
