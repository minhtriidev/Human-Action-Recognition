...
video_files_dict = {
    ...
    'action8': sorted(glob.glob('D:/Documents/aHCMUT_Documents/DATN/BLENDER/TRAIN_VAL_TEST_6/test/wave/*.mp4'), key=os.path.getmtime),
    'action9': sorted(glob.glob('D:/Documents/aHCMUT_Documents/DATN/BLENDER/TRAIN_VAL_TEST_6/test/clap/*.mp4'), key=os.path.getmtime),
...
np.save('D:/Documents/aHCMUT_Documents/DATN/BLENDER/TRAIN_VAL_TEST_7/train_data_9action_7.npy', data)

# Create test_label.npy
label = np.repeat(np.arange(len(video_files_dict)), N // len(video_files_dict))
np.save('D:/Documents/aHCMUT_Documents/DATN/BLENDER/TRAIN_VAL_TEST_7/train_label_9action_7.npy', label)
